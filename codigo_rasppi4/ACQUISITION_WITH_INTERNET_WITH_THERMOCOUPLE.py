            ...
            try:
                if len(data_sensors) == 176:
                    ...
                    if len(data_sensors) > 20:
                        ...
                        data_sensors += thermocouple_buffer
...
while True:
    if interrupt_flag:
        ...
        thread1.start()
        #########
        thread2 = threading.Thread(target=thermocouple_thread)
        thread2.start()
        # #########
        ...
        thread_data_socket = threading.Thread(target=send_data_packet)
